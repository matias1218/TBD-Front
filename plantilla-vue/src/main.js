...
import tweetListlegal from './tweets/tweetsLegal.vue';
import tweetListmedic from './tweets/tweetsMedicinal.vue';
...
const routes = [
  ...
  { path:'/tweetListlegal', component: tweetListlegal},
  { path:'/tweetListmedic', component: tweetListmedic},

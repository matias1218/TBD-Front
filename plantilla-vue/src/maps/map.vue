...
export default{
  ...
  mounted:function(){
	    ...
	    .then(response=>{
  		...
  		this.$http.get('http://localhost:8081/tbd-tweeds-backend/approvalTopicByRegions/1').then(response=>{
		  this.approval1 = response.body.approval;
		  console.log(this.approval1);

		  this.$http.get('http://localhost:8081/tbd-tweeds-backend/approvalTopicByRegions/2').then(response=>{
		  	this.approval2 = response.body.approval;
		  	console.log(this.approval2);

		  		this.$http.get('http://localhost:8081/tbd-tweeds-backend/approvalTopicByRegions/3').then(response=>{
			  	this.approval3 = response.body.approval;
			  	console.log(this.approval3);

			  		this.$http.get('http://localhost:8081/tbd-tweeds-backend/approvalTopicByRegions/4').then(response=>{
					  	this.approval4 = response.body.approval;
					  	console.log(this.approval4);

					  		this.$http.get('http://localhost:8081/tbd-tweeds-backend/approvalTopicByRegions/5').then(response=>{
						  	this.approval5 = response.body.approval;
						  	console.log(this.approval5);

						  		this.$http.get('http://localhost:8081/tbd-tweeds-backend/approvalTopicByRegions/6').then(response=>{
							  	this.approval6 = response.body.approval;
							  	console.log(this.approval6);

							  		this.$http.get('http://localhost:8081/tbd-tweeds-backend/approvalTopicByRegions/7').then(response=>{
								  	this.approval7 = response.body.approval;
								  	console.log(this.approval7);

								  		this.$http.get('http://localhost:8081/tbd-tweeds-backend/approvalTopicByRegions/8').then(response=>{
									  	this.approval8 = response.body.approval;
									  	console.log(this.approval8);

									  		this.$http.get('http://localhost:8081/tbd-tweeds-backend/approvalTopicByRegions/9').then(response=>{
											  	this.approval9 = response.body.approval;
											  	console.log(this.approval9);

											  		this.$http.get('http://localhost:8081/tbd-tweeds-backend/approvalTopicByRegions/10').then(response=>{
													  	this.approval10 = response.body.approval;
													  	console.log(this.approval10);

													  		this.$http.get('http://localhost:8081/tbd-tweeds-backend/approvalTopicByRegions/11').then(response=>{
															  	this.approval11 = response.body.approval;
															  	console.log(this.approval11);

															  		this.$http.get('http://localhost:8081/tbd-tweeds-backend/approvalTopicByRegions/12').then(response=>{
																	  	this.approval12 = response.body.approval;
																	  	console.log(this.approval12);

																	  		this.$http.get('http://localhost:8081/tbd-tweeds-backend/approvalTopicByRegions/13').then(response=>{
																			  	this.approval13 = response.body.approval;
																			  	console.log(this.approval13);

																			  		this.$http.get('http://localhost:8081/tbd-tweeds-backend/approvalTopicByRegions/14').then(response=>{
																					  	this.approval14 = response.body.approval;
																					  	console.log(this.approval14);

																					  		this.$http.get('http://localhost:8081/tbd-tweeds-backend/approvalTopicByRegions/15').then(response=>{
																							  	this.approval15 = response.body.approval;
																							  	console.log(this.approval15);
																							  	this.mapa(this.approval1,this.approval2,this.approval3,this.approval4,this.approval5,this.approval6,this.approval7,this.approval8,this.approval9,this.approval10,this.approval11,this.approval12,this.approval13,this.approval14,this.approval15,this.category1);
